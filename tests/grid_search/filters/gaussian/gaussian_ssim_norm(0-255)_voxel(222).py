...
def grid_search_smoothing_ssim(file_path):
    """
...
if __name__ == "__main__":
    ...
    best_params, all_results = grid_search_smoothing_ssim(file_path)

    # Save results
    output_file_name = "gaussian_ssim_results_norm(0-255)_voxel(222).csv"
    best_output_file_name = "gaussian_ssim_best_norm(0-255)_voxel(222).csv"
