...
if __name__ == "__main__":
    ...
    best_params, all_results = grid_search_median_mse_psnr(file_path)

    # Save results
    output_file_name = "median_mse_psnr_results_norm(0-255)_voxel(222).csv"
    best_output_file_name = "median_mse_psnr_best_norm(0-255)_voxel(222).csv"
