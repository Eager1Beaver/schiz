...
def grid_search_wavelet_ssim(file_path):
    """
    ...
    for wavelet, level, threshold, thresholding_mode, boundary_mode in param_grid:
        try:
            ...
            # Calculate SSIM
            ssim_val = calculate_ssim(original_data, wavelet_data_matched)
...
if __name__ == "__main__":
    ...
    best_params, all_results = grid_search_wavelet_ssim(file_path)

    # Save results
    output_file_name = "wavelet_ssim_results.csv"
    best_output_file_name = "wavelet_ssim_best.csv"
