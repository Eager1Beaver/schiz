...
def plot_save_selected_slices(path_to_best_image, isSave_slices=False):
    ...
    #ax.set_title(title)
    if isSave_slices:
        save_fig_to = 'best_image_slices_full_preproc.png'
...
if __name__ == "__main__":
    ...
    path_to_all_results = 'test_full_preproc_image_all_results.csv'
    path_to_best_image = 'test_full_preproc_image_best_image.csv'
