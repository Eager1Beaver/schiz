...
def evaluate_raw_images(paths_to_images):
    ...
    for path in paths_to_images:
        ...
        resampled_image = resample_image(nii, order=5, voxel_size=(1.0, 1.0, 1.0))
...
def plot_save_selected_slices(path_to_best_image, isSave_slices=False):
    ...
    #ax.set_title(title)
    if isSave_slices:
        save_fig_to = 'best_image_slices_full_preproc_voxel_111.png'
...
if __name__ == "__main__":
    ...
    path_to_all_results = 'test_full_preproc_image_voxel_111_all_results.csv'
    path_to_best_image = 'test_full_preproc_image_voxel_111_best_image.csv'
